...
def get_parse():
    ...
    parser.add_argument('--train_path',
                        default='/home/rhk/projects/gcp_vm/keywords/data/ccf_data_jiebatr/train.csv',
                        help='train_path')
    parser.add_argument('--train_tfidf_path',
                        default='/home/rhk/projects/gcp_vm/keywords/data/ccf_data_jiebatr/train_jiebatr.csv',
                        help='train_path')
    parser.add_argument('--dev_path', default='/home/rhk/projects/gcp_vm/keywords/data/ccf_data_jiebatr/dev.csv',
                        help='eval_path')
    parser.add_argument('--dev_tfidf_path',
                        default='/home/rhk/projects/gcp_vm/keywords/data/ccf_data_jiebatr/dev_jiebatr.csv',
                        help='eval_path')
    parser.add_argument('--test_path',
                        default='/home/rhk/projects/gcp_vm/keywords/data/ccf_data_jiebatr/Test_DataSet.csv',
                        help='test_path')
    parser.add_argument('--test_tfidf_path',
                        default='/home/rhk/projects/gcp_vm/keywords/data/ccf_data_jiebatr/Test_DataSet_jiebatr.csv',
                        help='test_path')
...
def write_train_dev(file, new_file):
    ...
    for row in dataset.iterrows():
        try:
            keywords = jieba.analyse.textrank(row[1]['content'], topK=20)
